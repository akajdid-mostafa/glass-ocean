    ...
    <section className="py-16 px-4 bg-gray-50">
      <div className=" mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-5xl bg-gradient-to-r from-blue600 to-red600 bg-clip-text text-transparent font-bold mb-4">Most Popular Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {services.map((service, index) => (
            <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden relative">
              <div className="p-6">
                <div className="w-40 h-40 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue600 to-red600 flex items-center justify-center">
                  <img src={service.image} alt={service.title} className="w-36 h-36 object-cover rounded-full" />
                </div>
