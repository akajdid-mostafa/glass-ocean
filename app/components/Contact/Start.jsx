    ...
    <div>
      ...
      <div className="container flex flex-col items-center justify-center w-full p-6 mx-auto text-center xl:px-0">
        ...
        <p className="max-w-6xl py-2 text-md leading-normal text-lightgrey lg:text-md xl:text-md dark:text-gray-300">
          Bienvenue chez Ocean Connecting ! Nous sommes heureux de vous proposer
          des services de nettoyage de façades de bâtiments et de panneaux
          solaires de premier ordre. Veuillez remplir le formulaire de contact
          ci-dessous pour nous contacter. Nous sommes là pour veiller à ce que
          votre propriété brille et fonctionne de manière optimale. Merci de
          nous avoir choisis !{" "}
        </p>
      </div>
    </div>
