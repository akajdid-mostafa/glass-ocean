...
const cardData: cardDataType[] = [
  ...
  },
  {
    ...
    subheading: "Des horaires flexibles, ajustés à vos besoins spécifiques.",
    link: "En savoir plus",
  },
  {
    ...
    heading: "Continuité",
    subheading:
      "Un service constant et fiable pour des espaces toujours impeccables.",
    link: "En savoir plus",
  },
];
        ...
        <div className="text-center mb-14">
          ...
          >
            <h3 className="text-lg font-normal mb-3 ls-51 uppercase">
              Les Avantages d&apos;Ocean-Glass Propreté
            </h3>
          </Fade>
          <Fade
            direction={"up"}
          ...
          <div className="text-center mt-4 flex justify-center">
            ...
            >
              <p className="max-w-5xl text-lg font-semibold">
                Spécialisés dans le nettoyage et l&apos;entretien, y compris les
                façades et bâtiments de grande hauteur, nous offrons des
                services de propreté de haute qualité pour tous vos locaux
                professionnels.{" "}
              </p>
            </Fade>
          </div>
